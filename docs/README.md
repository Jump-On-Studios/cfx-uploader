# CFX Uploader Documentation

This directory contains project notes and integration guides that are useful for maintainers and advanced integrations.
...
For public package usage, start with the root [README](../README.md).
